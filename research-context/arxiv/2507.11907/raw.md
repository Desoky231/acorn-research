...
https://patents.google.com/patent/US20090228432A1/en
.
...
Sanjay Agrawal, Surajit Chaudhuri, and Vivek R Narasayya. 2000.
...
Georgios Amanatidis, Federico Fusco, Philip Lazos, Stefano Leonardi, Alberto Marchetti-Spaccamela, and Rebecca Reiffenhäuser. 2021.

Submodular maximization subject to a knapsack constraint: Combinatorial algorithms with near-optimal adaptive complexity. In
...
Luıs A Nunes Amaral, Antonio Scala, Marc Barthelemy, and H Eugene Stanley. 2000.

Classes of small-world networks.

Proceedings of the national academy of sciences
97, 21 (2000), 11149–11152.

Aouiche et al
.
(2006)

Kamel Aouiche, Pierre-Emmanuel Jouve, and Jérôme Darmont. 2006.

Clustering-based materialized view selection in data warehouses. In
East European conference on advances in databases and information systems
. Springer, 81–95.

Aude Oliva ([n.d.])

Antonio Torralba Aude Oliva. [n.d.].
...
Apache calcite: A foundational framework for optimized query processing over heterogeneous data sources. In
...
YFCC10M - Neurips23 BigANN Challenge Filter Track.
...
Samy Chambi, Daniel Lemire, Owen Kaser, and Robert Godin. 2016.
...
https://courses.grainger.illinois.edu/cs586/sp2022/main.pdf
.
...
David P Dobkin, Steven J Friedman, and Kenneth J Supowit. 1990.
...
Joshua Engels, Ben Landrum, Shangdi Yu, Laxman Dhulipala, and Julian Shun. [n.d.].

Approximate Nearest Neighbor Search with Window Filters. In
...
arXiv preprint arXiv:1707.00143
(2017).

Gao and Long (2023)

Jianyang Gao and Cheng Long. 2023.
...
Parke Godfrey, Jarek Gryz, Andrzej Hoppe, Wenbin Ma, and Calisto Zuzarte. 2009.

Query rewrites with views for XML in DB2. In
2009 IEEE 25th International Conference on Data Engineering
. IEEE, 1339–1350.

Goldstein and Larson (2001)

Jonathan Goldstein and Per-Åke Larson. 2001.

Optimizing queries using materialized views: a practical, scalable solution.

SIGMOD Rec.
30, 2 (May 2001), 331–342.
...
Siddharth Gollapudi, Neel Karia, Varun Sivashankar, Ravishankar Krishnaswamy, Nikit Begwani, Swapnil Raz, Yiyong Lin, Yin Zhang, Neelam Mahapatro, Premkumar Srinivasan, et al
.
2023.

Filtered-diskann: Graph algorithms for approximate nearest neighbor search with filters. In
...
Gaurav Gupta, Jonah Yi, Benjamin Coleman, Chen Luo, Vihan Lakshman, and Anshumali Shrivastava. 2023.

CAPS: A Practical Partition Index for Filtered Similarity Search.

arXiv preprint arXiv:2308.15014
(2023).
...
Stratos Idreos, Martin L Kersten, Stefan Manegold, et al
.
2007.

Database Cracking.. In
CIDR
, Vol. 7. 68–78.
...
Milena G Ivanova, Martin L Kersten, Niels J Nes, and Romulo AP Gonçalves. 2010.
...
Alekh Jindal, Konstantinos Karanasos, Sriram Rao, and Hiren Patel. 2018.
...
Asterios Katsifodimos, Ioana Manolescu, and Vasilis Vassalos. 2012.

Materialized view selection for XQuery workloads. In
Proceedings of the 2012 ACM SIGMOD International Conference on Management of Data
(Scottsdale, Arizona, USA)
(SIGMOD ’12)
. Association for Computing Machinery, New York, NY, USA, 565–576.

https://doi.org/10.1145/2213836.2213900

Landrum et al
.
(2025)

Ben Landrum, Magdalen Dobson Manohar, Mazin Karjikar, and Laxman Dhulipala. 2025.

IVF2 Index: Fusing Classic and Spatial Inverted Indices for Fast Filtered ANNS. In
The 1st Workshop on Vector Databases
.

https://openreview.net/forum?id=kXw8E3xT7O

Li et al
.
(2023)

Zhaoheng Li, Xinyu Pi, and Yongjoo Park. 2023.

S/C: Speeding up Data Materialization with Bounded Memory. In
...
Information Management and Preservation. 2024.
...
Baharan Mirzasoleiman, Ashwinkumar Badanidiyuru, and Amin Karbasi. 2016.
...
Materialized view selection and maintenance using multi-query optimization. In
Proceedings of the 2001 ACM SIGMOD International Conference on Management of Data
(Santa Barbara, California, USA)
(SIGMOD ’01)
. Association for Computing Machinery, New York, NY, USA, 307–318.

https://doi.org/10.1145/375663.375703

Mohoney et al
.
(2023)

Jason Mohoney, Anil Pacaci, Shihabur Rahman Chowdhury, Ali Mousavi, Ihab F Ilyas, Umar Farooq Minhas, Jeffrey Pound, and Theodoros Rekatsinas. 2023.
...
Bilegsaikhan Naidan, Leonid Boytsov, Yury Malkov, and David Novak. 2015.

Non-metric space library manual.

arXiv preprint arXiv:1508.05470
(2015).
...
Mark EJ Newman, Cristopher Moore, and Duncan J Watts. 2000.
...
Liana Patel, Peter Kraft, Carlos Guestrin, and Matei Zaharia. 2024.

ACORN: Performant and Predicate-Agnostic Search Over Vector Embeddings and Structured Data.

Proc. ACM Manag. Data
2, 3, Article 120 (May 2024), 27 pages.
...
Karthikeyan Ramasamy, Prasad M Deshpande, Jeffrey F Naughton, and David Maier. 1998.

Set-Valued Attributes in O/R DBMS: Implementation Options and Performance Implications.

R DBMS: Implementation options and performance implications, Madison: University of Wisconsin
(1998).
...
Abhishek Roy, Alekh Jindal, Hiren Patel, Ashit Gosalia, Subru Krishnan, and Carlo Curino. 2019.

Sparkcruise: Handsfree computation reuse in spark.

Proceedings of the VLDB Endowment
12, 12 (2019), 1850–1853.

Sanca and Ailamaki (2024)

Viktor Sanca and Anastasia Ailamaki. 2024.

Efficient Data Access Paths for Mixed Vector-Relational Search. In
...
Aneesh Sharma, Jerry Jiang, Praveen Bommannavar, Brian Larson, and Jimmy Lin. 2016.
...
Amit Shukla, Prasad Deshpande, Jeffrey F Naughton, et al
.
1998.

Materialized view selection for multidimensional datasets. In
VLDB
, Vol. 98. 488–499.
...
arXiv preprint arXiv:2409.17424
(2024).
...
Justin JongSu Song, Wookey Lee, and Jafar Afshar. 2019.
...
Liwen Sun, Michael J Franklin, Sanjay Krishnan, and Reynold S Xin. 2014.
...
Liwen Sun, Michael J Franklin, Jiannan Wang, and Eugene Wu. 2016.
...
Dimitri Theodoratos and Wugang Xu. 2004.

Constructing search spaces for materialized view selection. In
...
http://staff.itee.uq.edu.au/shenht/UQVIDEO/
.
...
Milvus: A purpose-built vector data management system. In
...
Mengzhao Wang, Lingwei Lv, Xiaoliang Xu, Yuxiang Wang, Qiang Yue, and Jiongkang Ni. 2022.

Navigable proximity graph-driven native hybrid queries with structured and unstructured constraints.

arXiv preprint arXiv:2203.13601
(2022).
...
Zeyu Wang, Qitong Wang, Xiaoxing Cheng, Peng Wang, Themis Palpanas, and Wei Wang. 2024.

Steiner-hardness: A query hardness measure for graph-based ann indexes.

Proceedings of the VLDB Endowment
17, 13 (2024), 4668–4682.
...
Skip List Data Structure - Wikipedia.
...
Wei Wu, Junlin He, Yu Qiao, Guoheng Fu, Li Liu, and Jin Yu. 2022.

HQANN: Efficient and robust similarity search for hybrid queries with structured and unstructured constraints. In
...
Qd-tree: Learning Data Layouts for Big Data Analytics. In
Proceedings of the 2020 ACM SIGMOD International Conference on Management of Data
(Portland, OR, USA)
(SIGMOD ’20)
. Association for Computing Machinery, New York, NY, USA, 193–208.
...
Zhengyu Yang, Danlin Jia, Stratis Ioannidis, Ningfang Mi, and Bo Sheng. 2018.

Intermediate data caching optimization for multi-stage and parallel big data frameworks. In
...
Greedy set-cover algorithms (1974-1979, chvátal, johnson, lovász, stein).
...
Chuan Zhang, Xin Yao, and Jian Yang. 2001.
...
Li Zhaoheng, Huang Silu, Ding Wei, Park Yongjoo, and Chen Jianjun. [n.d.].

SIEVE Technical Report.

https://billyzhaohengli.github.io/assets/pdf/SIEVE_tech_report.pdf
.
...
Li Zhaoheng, Huang Silu, Ding Wei, Park Yongjoo, and Chen Jianjun. 2025.
...
Chaoji Zuo, Miao Qiao, Wenchao Zhou, Feifei Li, and Dong Deng. 2024.
